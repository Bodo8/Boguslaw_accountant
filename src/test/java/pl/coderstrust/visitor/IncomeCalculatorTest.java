...
public class IncomeCalculatorTest {
  ...
  @Test
  public void shouldReturnTotalIncomeFromInvoiceBook() throws Exception {
    //given
    ...
    InvoiceVisitor visitor = new IncomeCalculator();
    BigDecimal expected = BigDecimal.valueOf(numberOfInvoices)
        .multiply(invoices.get(0).getInvoiceItems().get(0).getAmount());
  ...
  @Test
  public void shouldReturnNullAsIncomeFromInvoiceBook() throws Exception {
    //given
    InvoiceBook invoiceBook = new InvoiceBook(new InMemoryDatabase());
    int numberOfInvoices = 20;
    List<Invoice> invoices = InvoiceGeneratorForTests
