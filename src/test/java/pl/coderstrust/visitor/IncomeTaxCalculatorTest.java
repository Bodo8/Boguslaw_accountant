...
public class IncomeTaxCalculatorTest {
  ...
  @Test
  public void shouldReturnTotalIncomeTaxFromInvoiceBook() throws Exception {
    //given
    ...
    InvoiceVisitor visitor = new IncomeTaxCalculator();
  ...
  @Test
  public void shouldReturnNullAsIncomeTaxFromInvoiceBook() throws Exception {
    //given
    InvoiceBook invoiceBook = new InvoiceBook(new InMemoryDatabase());
    int numberOfInvoices = 20;
    List<Invoice> invoices = InvoiceGeneratorForTests
